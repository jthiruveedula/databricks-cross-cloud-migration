...
const SPECS = [
  ...
  { type: 'dataflow', name: 'asset-inventory.dataflow' },
  { type: 'workflow', name: 'dependency-mapping.workflow' },
  { type: 'workflow', name: 'risk-assessment.workflow' },
  { type: 'sequence', name: 'ai-assisted-assessment.sequence' },
  { type: 'sequence', name: 'target-storage-credentials.sequence' },
  { type: 'workflow', name: 'secrets-and-kms.workflow' },
  { type: 'workflow', name: 'serverless-networking.workflow' },
  { type: 'architecture', name: 'network-security.architecture' },
  { type: 'workflow', name: 'identity-federation.workflow' },
  { type: 'lifecycle', name: 'data-residency.lifecycle' },
  { type: 'architecture', name: 'unity-catalog-strategy.architecture' },
  { type: 'workflow', name: 'ucx-strategy.workflow' },
  { type: 'workflow', name: 'grants-and-roles.workflow' },
  { type: 'workflow', name: 'row-column-security.workflow' },
  { type: 'workflow', name: 'external-locations-and-volumes.workflow' },
  { type: 'lifecycle', name: 'legacy-hive-transition.lifecycle' },
  { type: 'workflow', name: 'cluster-migration.workflow' },
  { type: 'workflow', name: 'cluster-policies.workflow' },
  { type: 'workflow', name: 'runtime-upgrade.workflow' },
  { type: 'workflow', name: 'workflows-jobs.workflow' },
  { type: 'workflow', name: 'cicd-promotion.workflow' },
  { type: 'workflow', name: 'external-orchestrators.workflow' },
  { type: 'workflow', name: 'dashboards.workflow' },
  { type: 'workflow', name: 'bi-tool-reconnection.workflow' },
  { type: 'workflow', name: 'notebooks-and-repos.workflow' },
  { type: 'sequence', name: 'mlflow.sequence' },
  { type: 'workflow', name: 'model-registry.workflow' },
  { type: 'workflow', name: 'serving-and-artifacts.workflow' },
  { type: 'lifecycle', name: 'what-does-not-migrate.lifecycle' },
  { type: 'workflow', name: 'decommissioning.workflow' },
  { type: 'workflow', name: 'rollback.workflow' },
  { type: 'lifecycle', name: 'hypercare.lifecycle' },
  { type: 'architecture', name: 'databricks-tooling.architecture' },
  { type: 'workflow', name: 'cross-cloud-collaboration.workflow' },
