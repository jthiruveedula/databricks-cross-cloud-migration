...
Thirty-two interactive diagrams (six cloud-pair architectures, four discovery diagrams, six security diagrams, six governance diagrams, six compute/pipelines diagrams, data flow, cutover workflow, event sequence, per-table
